...
parser.add_argument(
    ...
    type=int,
    default=10,
    help="Sequence length (number of SLAM input frames)\n",
)
...
if __name__ == "__main__":
    ...
    # load dataset
    if args.dataset == "icl":
        dataset = ICL(args.dataset_path, seqlen=args.seqlen, height=120, width=160)
    elif args.dataset == "tum":
        dataset = TUM(args.dataset_path, seqlen=args.seqlen, height=120, width=160)
    ...
    # SLAM
    slam = PointFusion(odom=args.odometry, dsratio=1, device=device)
